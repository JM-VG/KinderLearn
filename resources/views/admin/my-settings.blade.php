...
<div class="max-w-2xl space-y-5">
    ...
    <div class="bg-white rounded-3xl p-6 shadow-sm">
        <h2 class="font-fredoka text-xl text-gray-800 mb-4 flex items-center gap-2">
            <i class="ri-palette-line text-indigo-400"></i> Appearance
        </h2>
    ...
    <div class="bg-white rounded-3xl p-6 shadow-sm">
        <h2 class="font-fredoka text-xl text-gray-800 mb-4 flex items-center gap-2">
            <i class="ri-volume-up-line text-indigo-400"></i> Sound
        </h2>
        ...
        <div class="flex items-center justify-between py-3 border-b border-gray-100">
            ...
            <button id="sfx-toggle" onclick="toggleSetting('sfx')"
                    class="w-12 h-6 rounded-full transition-colors relative" style="background:#6366f1;">
        ...
        <div class="py-3">
            ...
            <input type="range" id="vol-slider" min="0" max="100" value="80"
                   oninput="setVolume(this.value)" class="w-full accent-indigo-500">
            <div class="flex justify-between text-xs text-gray-400 mt-1">
                <span>0%</span><span>50%</span><span>100%</span>
            </div>
            <button onclick="previewTTS()"
                    class="mt-3 px-4 py-2 rounded-xl border-2 border-indigo-200 text-indigo-500 font-bold text-xs hover:bg-indigo-50 transition flex items-center gap-2">
    ...
    <div class="bg-white rounded-3xl p-6 shadow-sm">
        <h2 class="font-fredoka text-xl text-gray-800 mb-4 flex items-center gap-2">
            <i class="ri-eye-line text-indigo-400"></i> Accessibility
        </h2>
...
function syncThemeButtons(t) {
    ...
    bDark.style.cssText  = dark  ? 'border-color:#6366f1;color:#fff;background:#6366f1;'   : 'border-color:#e5e7eb;color:#6b7280;background:#fff;';
    bLight.style.cssText = !dark ? 'border-color:#6366f1;color:#6366f1;background:#eef2ff;' : 'border-color:#e5e7eb;color:#9ca3af;background:#fff;';
}
...
function applyToggle(key, on) {
    ...
    if (!btn) return;
    btn.style.background = on ? '#6366f1' : '#e5e7eb';
