...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'KinderLearn'); ?> | KinderLearn</title>
...
<div id="flash-msg" class="fixed top-4 right-4 z-50 bg-blue-500 text-white px-6 py-4 rounded-2xl shadow-xl flex items-center gap-3 text-lg font-bold">
    <span>ℹ️</span> <?php echo e(session('info')); ?>
...
<?php /**PATH C:\laragon\www\kinderlearn\resources\views/layouts/app.blade.php ENDPATH**/ ?>