...
<div class="min-h-screen flex">
    ...
    <div class="hidden md:flex flex-col justify-center items-center flex-1 text-white p-12"
        ...
        <div class="grid grid-cols-2 gap-4 w-full max-w-xs">
            ...
            ?>
            <?php $__currentLoopData = $subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$fa, $label]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="bg-white bg-opacity-20 rounded-2xl p-4 text-center font-bold">
                <i class="<?php echo e($fa); ?>"></i> <?php echo e($label); ?>
        ...
        <div class="w-full max-w-md">
            ...
            <div class="mt-6 text-center">
                <p class="text-gray-500 font-semibold">
                    ...
                    <a href="<?php echo e(route('register')); ?>" class="text-orange-500 font-bold hover:underline">
                        Create one free!
                    </a>
                </p>
            </div>
            ...
            <div class="mt-4 text-center">
                <a href="<?php echo e(route('home')); ?>" class="text-gray-400 hover:text-gray-600 font-semibold">
                    ← Back to Homepage
                </a>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\kinderlearn\resources\views/auth/login.blade.php ENDPATH**/ ?>