...
<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
    ...
    <div class="bg-white rounded-3xl p-6 shadow-sm">
        ...
        <form method="POST" action="<?php echo e(route('teacher.announcements.store')); ?>" class="space-y-4">
            <?php echo csrf_field(); ?>
            <div>
    ...
    <div class="bg-white rounded-3xl p-6 shadow-sm">
        ...
        <div class="p-4 rounded-2xl mb-3 border-2 <?php echo e($ann->pinned ? 'bg-sky-50 border-sky-200' : 'bg-gray-50 border-transparent'); ?>">
            <?php if($ann->pinned): ?>
            <span class="text-xs font-bold px-2 py-0.5 rounded-full"
                  style="background:rgba(14,165,233,0.12);color:#0ea5e9;"><i class="fa-solid fa-thumbtack"></i> Pinned</span>
            <?php endif; ?>
            <div class="font-bold text-gray-800 mt-1"><?php echo e($ann->title); ?></div>
            <p class="text-sm text-gray-500 mt-1"><?php echo e(Str::limit($ann->body, 100)); ?></p>
            <div class="flex items-center justify-between mt-3">
                <span class="text-xs text-gray-400"><?php echo e($ann->created_at->diffForHumans()); ?></span>
                <div class="flex items-center gap-2">
                    <button onclick="openEditModal(<?php echo e($ann->id); ?>, <?php echo e(json_encode($ann->title)); ?>, <?php echo e(json_encode($ann->body)); ?>, <?php echo e($ann->pinned ? 'true' : 'false'); ?>)"
                            class="text-xs font-bold text-sky-500 hover:text-sky-700 transition">
                        <i class="ri-edit-line"></i> Edit
                    </button>
                    <form method="POST" action="<?php echo e(route('teacher.announcements.destroy', $ann->id)); ?>"
...
<?php echo $__env->make('layouts.teacher', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\kinderlearn\resources\views/teacher/announcements.blade.php ENDPATH**/ ?>