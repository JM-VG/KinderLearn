...
<div class="flex h-screen overflow-hidden" style="background-color: #f5f7fb;">
    ...
    <aside id="main-sidebar" class="fixed inset-y-0 left-0 z-30 flex flex-col">
        <nav class="flex flex-col gap-0.5 flex-1 px-2 overflow-y-auto pb-4 pt-4">
            ...
            <a href="<?php echo e(route('teacher.dashboard')); ?>"
               class="sb-link <?php echo e(request()->routeIs('teacher.dashboard') ? 'sb-active' : ''); ?>">
            ...
            <a href="<?php echo e(route('teacher.classes')); ?>"
               ...
               class="sb-link <?php echo e(request()->routeIs('teacher.classes*') || request()->routeIs('teacher.students*') ? 'sb-active' : ''); ?>">
                <span class="sb-icon"><i class="ri-school-line"></i></span>
                <span class="sb-label">My Classes</span>
            </a>

            <a href="<?php echo e(route('teacher.modules')); ?>"
               data-tour="link-modules"
               class="sb-link <?php echo e(request()->routeIs('teacher.modules*') ? 'sb-active' : ''); ?>">
                <span class="sb-icon"><i class="ri-book-2-line"></i></span>
                <span class="sb-label">Modules</span>
            </a>

            <a href="<?php echo e(route('teacher.activities')); ?>"
               class="sb-link <?php echo e(request()->routeIs('teacher.activities*') ? 'sb-active' : ''); ?>">
            ...
            <a href="<?php echo e(route('teacher.progress')); ?>"
               class="sb-link <?php echo e(request()->routeIs('teacher.progress*') || request()->routeIs('teacher.analytics*') ? 'sb-active' : ''); ?>">
                <span class="sb-icon"><i class="ri-bar-chart-2-line"></i></span>
                <span class="sb-label">Progress</span>
            </a>

            <a href="<?php echo e(route('teacher.reports')); ?>"
               class="sb-link <?php echo e(request()->routeIs('teacher.reports*') ? 'sb-active' : ''); ?>">
    ...
    <div id="content-wrapper" class="flex flex-col w-full overflow-hidden">
            ...
            <div class="flex items-center gap-1">
                ...
                <a href="<?php echo e(route('teacher.announcements')); ?>"
                   class="relative w-9 h-9 flex items-center justify-center rounded-lg text-gray-500
                          hover:bg-gray-100 hover:text-gray-800 transition <?php echo e(request()->routeIs('teacher.announcements*') ? 'bg-sky-50 text-sky-600' : ''); ?>"
                   title="Announcements">
                ...
                <div class="relative" id="profile-menu-wrap">
                    ...
                    <div id="profile-dropdown"
                        ...
                        <a href="<?php echo e(route('teacher.profile')); ?>" class="dd-item">
                            <i class="ri-user-line text-gray-400"></i> My Profile
                        </a>
                        <a href="<?php echo e(route('teacher.settings')); ?>" class="dd-item">
        ...
        <main class="flex-1 overflow-y-auto p-4 md:p-8">
            <?php echo $__env->yieldContent('teacher-content'); ?>
        </main>
    </div>
</div>
...
<script>
(function () {
    var CONVOS_URL  = '<?php echo e(route("teacher.messages.conversations")); ?>';
    var THREAD_BASE = '<?php echo e(url("/teacher/messages/thread")); ?>/';
    var SEARCH_URL  = '<?php echo e(route("teacher.messages.search")); ?>';
    var SEND_URL    = '<?php echo e(route("teacher.messages.send")); ?>';
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\kinderlearn\resources\views/layouts/teacher.blade.php ENDPATH**/ ?>